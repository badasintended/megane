...
public class TechReborn implements MeganeModule {
    ...
    public void register(MeganeRegistrar registrar) {
        registrar
            ...
            .progress(FusionControlComputerBlockEntity.class, ProgressProvider.of(
                b -> A.A_01, b -> A.A_2, (b, i) -> b.inventory.getStack(i), b -> b.getProgressScaled(100)
            ))
            .progress(ElectricFurnaceBlockEntity.class, ProgressProvider.of(
                b -> A.A_0, b -> A.A_1, (b, i) -> b.inventory.getStack(i), b -> b.getProgressScaled(100)
            ))
            .progress(IronAlloyFurnaceBlockEntity.class, ProgressProvider.of(
                b -> A.A_01, b -> A.A_2, (b, i) -> b.inventory.getStack(i), b -> b.getProgressScaled(100)
            ))
            .progress(IronFurnaceBlockEntity.class, ProgressProvider.of(
                b -> A.A_0, b -> A.A_1, (b, i) -> b.inventory.getStack(i), b -> b.getProgressScaled(100)
            ))
            .progress(MatterFabricatorBlockEntity.class, ProgressProvider.of(
                b -> A_012345, b -> A_6789AB, (b, i) -> b.inventory.getStack(i), b -> b.getProgressScaled(100)
            ))
            .progress(RollingMachineBlockEntity.class, ProgressProvider.of(
                b -> b.craftingSlots, b -> A_9, (b, i) -> b.getInventory().getStack(i), b -> b.getProgressScaled(100)
            ))
            .progress(BaseFluidGeneratorBlockEntity.class, ProgressProvider.of(
