...
import lol.bai.megane.mixin.create.AccessContraption;
import lol.bai.megane.mixin.create.AccessMountedStorageManager;
    ...
    public void appendData(IDataWriter data, IServerAccessor<AbstractContraptionEntity> accessor, IPluginConfig config) {
        ...
        data.add(FluidData.class, res -> {
            ...
            res.add(FabricFluidData.of(1)
                .add(stack.getType(), stack.getAmount(), tank.getCapacity()));
        });
    }
