...
object deps {
    ...
    val wthit = "mcp.mobius.waila:wthit:fabric-5.6.1"
    val fabricApi = "net.fabricmc.fabric-api:fabric-api:0.57.0+1.19"
    val modmenu = "com.terraformersmc:modmenu:4.0.0"

    val ae2 = "appeng:appliedenergistics2-fabric:12.0.1-alpha"
    ...
    val extraGen = "curse.maven:extra-generators-475623:3856206"
    ...
    val libgui = "io.github.cottonmc:LibGui:6.0.0+1.19"
    ...
    val wirelessNet = "curse.maven:wireless-networks-461316:3876132"
